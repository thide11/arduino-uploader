...
public class UsbSerialManager {
    ...
    public static final String ACTION_USB_NOT_SUPPORTED = "xyz.vidieukhie.embedded.device.USB_NOT_SUPPORTED";
    public static final String ACTION_NO_USB = "xyz.vidieukhie.embedded.device.NO_USB";
    public static final String ACTION_USB_PERMISSION_GRANTED = "xyz.vidieukhie.embedded.device.USB_PERMISSION_GRANTED";
    public static final String ACTION_USB_PERMISSION_NOT_GRANTED = "xyz.vidieukhie.embedded.device.USB_PERMISSION_NOT_GRANTED";
    public static final String ACTION_USB_PERMISSION_REQUEST = "xyz.vidieukhie.embedded.device.ACTION_USB_PERMISSION_REQUEST";
    public static final String ACTION_USB_DISCONNECTED = "xyz.vidieukhie.embedded.device.ACTION_USB_DISCONNECTED";
    public static final String ACTION_USB_CONNECT = "xyz.vidieukhie.embedded.device.ACTION_USB_CONNECT";
    public static final String ACTION_USB_READY = "xyz.vidieukhie.embedded.device.USB_READY";
    public static final String ACTION_CDC_DRIVER_NOT_WORKING = "xyz.vidieukhie.embedded.device.ACTION_CDC_DRIVER_NOT_WORKING";
    public static final String ACTION_USB_DEVICE_NOT_WORKING = "xyz.vidieukhie.embedded.device.ACTION_USB_DEVICE_NOT_WORKING";
